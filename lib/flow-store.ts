...
import type { FlowState, FlowStep, ReferenceStyle, Placement, VariationCount, GenerationResult, AdjustmentSettings, TextStyling, DoorDetectionResult, SignSizeResult } from "@/types"
...
const STEP_ORDER: FlowStep[] = ["upload", "variations", "generate", "download"]
