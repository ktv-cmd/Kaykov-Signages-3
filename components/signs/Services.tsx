...
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/signs/ui/card";
import { Badge } from "@/components/signs/ui/badge";
...
const lightbox1 = "/signs/assets/outdoor /2d /light throug/Laundry loft .JPG";
const lightbox2 = "/signs/assets/outdoor /2d /light throug/1.jpg";
const lightbox3 = "/signs/assets/outdoor /2d /light throug/18.jpg";
const lightbox4 = "/signs/assets/outdoor /2d /light throug/3 11.jpg";
const lightbox5 = "/signs/assets/outdoor /2d /light throug/3D outdoor no light.jpg";
const lightbox6 = "/signs/assets/outdoor /2d /light throug/4 2.jpg";
const lightbox7 = "/signs/assets/outdoor /2d /light throug/6.jpg";
const lightbox8 = "/signs/assets/outdoor /2d /light throug/Oral Sergery.JPG";
const lightbox9 = "/signs/assets/outdoor /2d /light throug/light box.jpg";
// Interior 3D LID indoor (with light) - ALL images from 3D LID indoor folder
const interiorWithLight1 = "/signs/assets/interiar /3D LID indoor/1 sweet.JPG";
const interiorWithLight2 = "/signs/assets/interiar /3D LID indoor/2 joe.JPG";
const interiorWithLight3 = "/signs/assets/interiar /3D LID indoor/3leviev.JPG";
const interiorWithLight4 = "/signs/assets/interiar /3D LID indoor/4 aldente.JPG";
const interiorWithLight5 = "/signs/assets/interiar /3D LID indoor/6 respect spa.JPG";
const interiorWithLight6 = "/signs/assets/interiar /3D LID indoor/7 UR.JPG";
const interiorWithLight7 = "/signs/assets/interiar /3D LID indoor/5.png";
// Interior 3D LID indoor images moved from back Lid folder
const interiorWithLight8 = "/signs/assets/interiar /3D LID indoor/2.jpg";
const interiorWithLight9 = "/signs/assets/interiar /3D LID indoor/3 3.jpg";
const interiorWithLight10 = "/signs/assets/interiar /3D LID indoor/5 2.jpg";
const interiorWithLight11 = "/signs/assets/interiar /3D LID indoor/fack lid.jpg";
// Interior 3D Letters Indoor (without light) - ALL images from 3d Letters Indoor folder
const interiorNoLight1 = "/signs/assets/interiar /3d Letters Indoor/1 tov.JPG";
const interiorNoLight2 = "/signs/assets/interiar /3d Letters Indoor/2 endodontic.jpg";
const interiorNoLight3 = "/signs/assets/interiar /3d Letters Indoor/2 tov2.JPG";
const interiorNoLight4 = "/signs/assets/interiar /3d Letters Indoor/3 Elliot Efraimoff.JPG";
const interiorNoLight5 = "/signs/assets/interiar /3d Letters Indoor/4Elliot.JPG";
const interiorNoLight6 = "/signs/assets/interiar /3d Letters Indoor/Shalom.JPG";
const interiorNoLight7 = "/signs/assets/interiar /3d Letters Indoor/jlgs.JPG";
const interiorNoLight8 = "/signs/assets/interiar /3d Letters Indoor/levy.jpg";
const interiorNoLight9 = "/signs/assets/interiar /3d Letters Indoor/mass.JPG";
const interiorNoLight10 = "/signs/assets/interiar /3d Letters Indoor/shimonov law.JPG";
const interiorNoLight11 = "/signs/assets/interiar /3d Letters Indoor/simply.JPG";
const interiorNoLight12 = "/signs/assets/interiar /3d Letters Indoor/smile.JPG";
const interiorNoLight13 = "/signs/assets/interiar /3d Letters Indoor/terkina.JPG";
const interiorNoLight14 = "/signs/assets/interiar /3d Letters Indoor/watch.JPG";
const interiorNoLight15 = "/signs/assets/interiar /3d Letters Indoor/indoor no light.jpg";
const interiorNoLight16 = "/signs/assets/interiar /3d Letters Indoor/indoorno lid.jpg";
// 3D not light images - ALL images from not light folder
const noLight1 = "/signs/assets/outdoor /3d signages /not light /no light 3d outdoor.jpg";
const noLight2 = "/signs/assets/outdoor /3d signages /not light /3 4.jpg";
const noLight3 = "/signs/assets/outdoor /3d signages /not light /Canarce.JPG";
const noLight4 = "/signs/assets/outdoor /3d signages /not light /Law office.JPG";
const noLight5 = "/signs/assets/outdoor /3d signages /not light /Medical Spa.JPG";
// LID Front Light images - ALL images from Front lid folder
const frontLid1 = "/signs/assets/outdoor /3d signages /Front lid /13.jpg";
const frontLid2 = "/signs/assets/outdoor /3d signages /Front lid /2 11.jpg";
const frontLid3 = "/signs/assets/outdoor /3d signages /Front lid /2 13.jpg";
const frontLid4 = "/signs/assets/outdoor /3d signages /Front lid /2 2.jpg";
const frontLid5 = "/signs/assets/outdoor /3d signages /Front lid /2 5.jpg";
const frontLid6 = "/signs/assets/outdoor /3d signages /Front lid /2 6.jpg";
const frontLid7 = "/signs/assets/outdoor /3d signages /Front lid /LVL UP.JPG";
const frontLid8 = "/signs/assets/outdoor /3d signages /Front lid /3 9.jpg";
const frontLid9 = "/signs/assets/outdoor /3d signages /Front lid /TOV Front .JPG";
const frontLid11 = "/signs/assets/outdoor /3d signages /Front lid /RGF home decore.JPG";
const frontLid12 = "/signs/assets/outdoor /3d signages /Front lid /Red Mango.JPG";
const frontLid13 = "/signs/assets/outdoor /3d signages /Front lid /Sweetlab.JPG";
// Front lid letter images (to be placed last)
const frontLidLetter1 = "/signs/assets/outdoor /3d signages /Front lid /A letter.JPG";
const frontLidLetter2 = "/signs/assets/outdoor /3d signages /Front lid /K2 letter .JPG";
const frontLidLetter3 = "/signs/assets/outdoor /3d signages /Front lid /Km2 letter.JPG";
const frontLidLetter4 = "/signs/assets/outdoor /3d signages /Front lid /front lid letter.JPG";
const frontLidLetter5 = "/signs/assets/outdoor /3d signages /Front lid /m letter.JPG";
// LID Back Light images - ALL images from back Lid folder
const backLid1 = "/signs/assets/outdoor /3d signages /back Lid /1 Average Derm.jpg";
const backLid2 = "/signs/assets/outdoor /3d signages /back Lid /2 7.jpg";
const backLid3 = "/signs/assets/outdoor /3d signages /back Lid /2 8.jpg";
const backLid6 = "/signs/assets/outdoor /3d signages /back Lid /3 8.jpg";
const backLid7 = "/signs/assets/outdoor /3d signages /back Lid /4 4.jpg";
const backLid8 = "/signs/assets/outdoor /3d signages /back Lid /4.jpg";
const backLid10 = "/signs/assets/outdoor /3d signages /back Lid /5 3.jpg";
const backLid13 = "/signs/assets/outdoor /3d signages /back Lid /8.jpg";
const backLid16 = "/signs/assets/outdoor /3d signages /back Lid /Mad.JPG";
const backLid17 = "/signs/assets/outdoor /3d signages /back Lid /Michell calon .JPG";
const backLid18 = "/signs/assets/outdoor /3d signages /back Lid /Smile creators.JPG";
const backLid19 = "/signs/assets/outdoor /3d signages /back Lid /Ultimate creatore.JPG";
const backLid21 = "/signs/assets/outdoor /3d signages /back Lid /law back lid.jpg";
// Back lid letter images (to be placed last)
const backLidLetter1 = "/signs/assets/outdoor /3d signages /back Lid /D letter.JPG";
const backLidLetter2 = "/signs/assets/outdoor /3d signages /back Lid /K2 letter.JPG";
// LID Back and Front images - ALL images from back and front lid folder
const backAndFrontLid1 = "/signs/assets/outdoor /3d signages /back and front lid 16/Adams.jpg";
const backAndFrontLid3b = "/signs/assets/outdoor /3d signages /back and front lid 16/Abaev Law.jpg";
const backAndFrontLid4 = "/signs/assets/outdoor /3d signages /back Lid /Mullaev Law Group.JPG";
const backAndFrontLid7 = "/signs/assets/outdoor /3d signages /back and front lid 16/3 10.jpg";
const backAndFrontLid8 = "/signs/assets/outdoor /3d signages /back and front lid 16/3 7.jpg";
const backAndFrontLid9 = "/signs/assets/outdoor /3d signages /back and front lid 16/4 3.jpg";
const backAndFrontLid10 = "/signs/assets/outdoor /3d signages /back and front lid 16/5.jpg";
const backAndFrontLid11 = "/signs/assets/outdoor /3d signages /back and front lid 16/Front amd back lid .jpg";
const backAndFrontLid13 = "/signs/assets/outdoor /3d signages /back and front lid 16/back lid 1.jpg";
// Back and front lid letter images (to be placed last)
const backAndFrontLidLetter1 = "/signs/assets/outdoor /3d signages /back and front lid 16/A letter.JPG";
const backAndFrontLidLetter2 = "/signs/assets/outdoor /3d signages /back and front lid 16/I letter.JPG";
const backAndFrontLidLetter3 = "/signs/assets/outdoor /3d signages /back and front lid 16/o letter.JPG";
const backAndFrontLidLetter4 = "/signs/assets/outdoor /3d signages /back and front lid 16/y letter.JPG";
const backAndFrontLidLetter5 = "/signs/assets/outdoor /3d signages /back and front lid 16/Y1 letter.JPG";
// Window signage images
const windowOutdoor1 = "/signs/assets/outdoor /2d /window outdoor/Body language.JPG";
const windowOutdoor2 = "/signs/assets/outdoor /2d /window outdoor/Levy .JPG";
const windowOutdoor3 = "/signs/assets/outdoor /2d /window outdoor/Mediacal office.JPG";
const windowOutdoor4 = "/signs/assets/outdoor /2d /window outdoor/Mediacal spa.JPG";
const windowOutdoor5 = "/signs/assets/outdoor /2d /window outdoor/Meds.JPG";
const windowOutdoor6 = "/signs/assets/outdoor /2d /window outdoor/Michel Claon.JPG";
// Awning signage images - ALL images from awning signages folder
const awning1 = "/signs/assets/outdoor /2d /awning signages/awning 1.jpg";
const awning2 = "/signs/assets/outdoor /2d /awning signages/forest hills express cafe.JPG";
const awning3 = "/signs/assets/outdoor /2d /awning signages/mediacal office.JPG";
const awning4 = "/signs/assets/outdoor /2d /awning signages/2 10.jpg";
const awning5 = "/signs/assets/outdoor /2d /awning signages/7.jpg";
const awning6 = "/signs/assets/outdoor /2d /awning signages/Metropolitan smiles.JPG";
