...
export default function FloatingContactButtons() {
  ...
  const handlePhoneClick = () => {
    trackPhoneClick("floating_contact_phone", `+${phoneNumber}`, "floating_contact_buttons");
  ...
  const handleWhatsAppClick = () => {
    ...
    trackCtaClick({
      ctaId: "floating_contact_whatsapp",
      ctaText: "WhatsApp",
      location: "floating_contact_buttons",
  ...
  const handleTelegramClick = () => {
    ...
    trackCtaClick({
      ctaId: "floating_contact_telegram",
      ctaText: "Telegram",
      location: "floating_contact_buttons",
