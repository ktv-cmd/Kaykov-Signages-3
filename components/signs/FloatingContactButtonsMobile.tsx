...
import { trackCtaClick, trackPhoneClick } from "@/lib/signs/analytics";
    ...
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 flex flex-col items-end gap-3 sm:gap-4">
      ...
      {isOpen && (
        <div className="flex flex-col gap-3 mb-2 animate-in fade-in slide-in-from-bottom-4 duration-300" style={{ animation: 'slideUpFadeIn 0.3s ease-out' }}>
          {/* Phone Button - Mobile Optimized: Larger touch target */}
          <button
            onClick={handlePhoneClick}
            className="group flex items-center justify-center gap-3 bg-primary hover:bg-primary/90 active:bg-primary/80 text-primary-foreground rounded-lg w-16 h-16 min-w-[64px] min-h-[64px] shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 active:scale-95 touch-manipulation"
            aria-label="Call"
            title="Call Us"
          ...
          <button
            ...
            className="group flex items-center justify-center gap-3 bg-[#25D366] hover:bg-[#25D366]/90 active:bg-[#25D366]/80 text-white rounded-lg w-16 h-16 min-w-[64px] min-h-[64px] shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 active:scale-95 touch-manipulation"
            aria-label="WhatsApp"
            title="WhatsApp"
            style={{ touchAction: 'manipulation' }}
          >
          ...
          <button
            ...
            className="group flex items-center justify-center gap-3 bg-[#0088cc] hover:bg-[#0088cc]/90 active:bg-[#0088cc]/80 text-white rounded-lg w-16 h-16 min-w-[64px] min-h-[64px] shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 active:scale-95 touch-manipulation"
            aria-label="Telegram"
            title="Telegram"
            style={{ touchAction: 'manipulation' }}
          >
          ...
          <button
            ...
            className="group flex items-center justify-center gap-3 bg-[#34C759] hover:bg-[#34C759]/90 active:bg-[#34C759]/80 text-white rounded-lg w-16 h-16 min-w-[64px] min-h-[64px] shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 active:scale-95 touch-manipulation"
            aria-label="SMS"
            title="Send SMS"
            style={{ touchAction: 'manipulation' }}
          >
      ...
      {/* Main Toggle Button - Mobile Optimized: Larger touch target */}
      <button
