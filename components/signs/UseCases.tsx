...
import { Card, CardContent, CardDescription, CardHeader } from "@/components/signs/ui/card";
...
const officeLobbyImage = "/signs/assets/interiar /3d Letters Indoor/1 tov.JPG";
const yardSignsImage = "/signs/assets/outdoor /3d signages /not light /Law office.JPG";
// menu-board.jpg and trade-show-banner.jpg not found, using alternative images
const menuBoardImage = "/signs/assets/outdoor /3d signages /Front lid /13.jpg";
const tradeShowBannerImage = "/signs/assets/outdoor /3d signages /Front lid /13.jpg";
const wayfindingSignsImage = "/signs/assets/outdoor /3d signages /Front lid /13.jpg";
// digital-led.jpg not found, using alternative image
const digitalLedImage = "/signs/assets/outdoor /3d signages /Front lid /13.jpg";
const useCases = [
  {
    icon: Building2,
