...
export default function ApplicationFormMobile({ onClose, inDialog = false }: ApplicationFormMobileProps = {}) {
  ...
  const formContent = (
    <>
        ...
        <div className="space-y-5 sm:space-y-6 pb-24 sm:pb-6">
          <div className="space-y-2">
            ...
            <Input 
              ...
              className={`min-h-[48px] h-12 sm:h-12 text-base touch-manipulation ${watchedName?.trim() ? "border-green-500 focus:border-green-500" : ""}`}
          ...
          <div className="space-y-2">
            ...
            <Input 
              ...
              className={`min-h-[48px] h-12 sm:h-12 text-base touch-manipulation ${watchedPhone?.trim() && !errors.phone ? "border-green-500 focus:border-green-500" : ""}`}
              style={{ touchAction: 'manipulation' }}
            />
            {errors.phone && (
          ...
          <div className="space-y-2">
            ...
            <Input 
              ...
              className={`min-h-[48px] h-12 sm:h-12 text-base touch-manipulation ${watchedEmail?.trim() && !errors.email ? "border-green-500 focus:border-green-500" : ""}`}
              style={{ touchAction: 'manipulation' }}
            />
            {errors.email && (
        ...
        <div className="space-y-5 sm:space-y-6 pb-24 sm:pb-6">
          <div className="space-y-2">
            ...
            <Input 
              ...
              className={`min-h-[48px] h-12 sm:h-12 text-base touch-manipulation ${watchedBusinessName?.trim() ? "border-green-500 focus:border-green-500" : ""}`}
              style={{ touchAction: 'manipulation' }}
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Input 
              ...
              className={`min-h-[48px] h-12 sm:h-12 text-base touch-manipulation ${watchedBusinessLocation?.trim() ? "border-green-500 focus:border-green-500" : ""}`}
              style={{ touchAction: 'manipulation' }}
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea 
              ...
              rows={4}
              className={`resize-none text-base min-h-[120px] touch-manipulation ${watchedDetails?.trim() ? "border-green-500 focus:border-green-500" : ""}`}
              style={{ touchAction: 'manipulation' }}
            />
          </div>
      ...
      {/* Sticky CTA for Mobile - Only visible on mobile when scrolling form */}
  ...
  if (inDialog) {
    return (
      <>
        <form onSubmit={handleSubmit(onSubmit)} noValidate className="w-full p-4 sm:p-6" style={{ touchAction: 'manipulation' }}>
          {formContent}
        </form>
      </>
    );
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} noValidate className="w-full" style={{ touchAction: 'manipulation' }}>
