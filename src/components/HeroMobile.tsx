...
import heroImageOutdoor from "@/assets/outdoor /2d /awning signages/awning 1.jpg";
import heroImageIndoor from "@/assets/interiar /3d Letters Indoor/indoor no light.jpg";
