  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-500 mt-1">Your selected design — download the mockup or go back to pick another.</p>
      </div>
      <div className="rounded-xl overflow-hidden bg-gray-900">
        {selectedCandidate?.imageUrl ? (
          <img src={selectedCandidate.imageUrl} alt="Selected design" className="w-full h-auto" />
        ) : (
