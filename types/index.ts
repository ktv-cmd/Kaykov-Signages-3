...
export interface FlowState {
  ...
  /** Door detection result from /api/detect-door, populated after storefront upload. */
  doorDetection?: DoorDetectionResult
  /** Estimated sign dimensions computed after placement confirmation. */
  signSize?: SignSizeResult
  /** UTM source or 'direct', read from URL on app load. */
  source?: string
}
